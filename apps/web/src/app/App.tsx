...
function AccountPage() {
  return (
    <div className="account-grid">
      <section className="surface account-profile"><SectionHeading title="身份资料" detail="CDK 是当前服务身份，浏览器仅保留短期会话。" /><div className="profile-row"><span className="avatar">C</span><div><strong>CDK 用户</strong><p>身份创建于 2026-08-21</p></div></div><div className="definition-list"><div><span>身份方式</span><b>CDK 凭证</b></div><div><span>当前会话</span><b>macOS · Safari</b></div><div><span>最近进入</span><b>今天 10:42</b></div></div><button className="quiet-button" type="button"><RefreshCw aria-hidden="true" size={16} />重新输入 CDK</button></section>
